ALTER TABLE "transactions" ADD COLUMN "from_address" text;--> statement-breakpoint
ALTER TABLE "transactions" ADD COLUMN "direction" text DEFAULT 'outgoing' NOT NULL;--> statement-breakpoint
